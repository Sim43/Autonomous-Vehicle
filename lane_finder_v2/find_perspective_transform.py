...
vp_x = float(vanishing_point[0])
vp_y = float(vanishing_point[1])
p1 = [vp_x - width / 2, float(top)]
p2 = [vp_x + width / 2, float(top)]
p3 = on_line(p2, [vp_x, vp_y], bottom)
p4 = on_line(p1, [vp_x, vp_y], bottom)
